...
parser.add_argument("--model_path", default="D:/HJQ/SeCo-master/SeCo-master/scripts/w_outputs/2025-03/train_voc_04-15-17-06/checkpoints/model_iter_20000.pth", type=str, help="model_path")
...
parser.add_argument("--data_folder", default='D:/HJQ/SeCo-master/SeCo-master/datasets/voc/VOCdevkit2012/VOC2012', type=str, help="dataset folder")
parser.add_argument("--infer_set", default="train", type=str, help="infer_set")
# parser.add_argument("--list_folder", default='datasets/voc', type=str, help="train/val/test list file")
parser.add_argument("--list_folder", default='D:/HJQ/SeCo-master/SeCo-master/datasets/voc', type=str, help="train/val/test list file")
