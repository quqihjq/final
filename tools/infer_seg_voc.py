...
parser.add_argument("--infer_set", default="val1", type=str, help="infer_set")
...
def crf_proc():
    ...
    results = joblib.Parallel(n_jobs=1, verbose=10, pre_dispatch="all")([joblib.delayed(_job)(i) for i in range(len(name_list))])
...
if __name__ == "__main__":
    ...
    setup_logger(filename=os.path.join(base_dir, f"{args.infer_set}_{cpt_name}_segs/results_700.log"))
