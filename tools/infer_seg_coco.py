...
parser.add_argument("--model_path", default="D:/HJQ/SeCo-master/SeCo-master/scripts/w_outputs_coco/2025-03/train_coco_14-11-53-03/checkpoints/model_iter_76000.pth", type=str, help="model_path")

parser.add_argument("--list_folder", default='D:/HJQ/SeCo-master/SeCo-master/datasets/coco', type=str, help="train/val/test list file")
...
parser.add_argument("--img_folder", default='D:/HJQ/SeCo-master/SeCo-master/datasets/coco/MSCOCO/coco2014', type=str, help="dataset folder")
parser.add_argument("--label_folder", default='D:/HJQ/SeCo-master/SeCo-master/datasets/coco/MSCOCO/SegmentationClass', type=str, help="dataset folder")
...
def crf_proc():
    ...
    results = joblib.Parallel(1, verbose=10, pre_dispatch="all")([joblib.delayed(_job)(i) for i in range(len(name_list))])
...
if __name__ == "__main__":
    ...
    setup_logger(filename=os.path.join(base_dir, f"{args.infer_set}_{cpt_name}_segs/results-3000.log"))
    print(args)
    validate(args=args)
